...
class CreateUserBuyCopyright extends Migration {
	...
	public function up()
	{
		Schema::create('user_buy_copyright', function(Blueprint $table)
		{
	
			$table->increments('id');
        	$table->string('pur_title',200);//求购著作权名称
        	$table->mediumInteger('category_id'); //求购著作权分类
