...
class CreateShopLogoOrdersTable extends Migration {
	...
	public function up()
	{
		Schema::create('shop_logo_orders', function(Blueprint $table)
		{
			$table->increments('id');
