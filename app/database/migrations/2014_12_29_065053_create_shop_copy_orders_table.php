...
class CreateShopCopyOrdersTable extends Migration {
	...
	public function up()
	{
		Schema::create('shop_copy_orders', function(Blueprint $table)
		{
			$table->increments('id');
			$table->string('order_code',20);
			$table->integer('user_id');
			$table->integer('copy_id');
			$table->string('copy_title',200);
			$table->string('copy_thumb',60);
