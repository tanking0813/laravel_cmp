@extends('member::publish.layouts.2columns-left')
@section('style')
...
@section('leftbar')
    ...
    <div class="myApplication common">
        <h3>我的应用</h3>
        <ul>
            <li class="buyer"><a href="{{ route('member.publish.buyer.add','logo') }}">我是买家</a></li>
...
@section('content')
    <div class="identify whiteBg ml0">
                ...
                <div class="row">
                    ...
                    <ul class="row h252">
                        <li class="col-xs-12 pa15">
                             <img src="{{ asset('modules/member/images/publish.png') }}"   height="50" width="180">
                        </li>
                        <li class="col-xs-6 pa15 center mt20"> 
                             <a href="{{ route('member.publish.buyer.add', 'logo') }}" class="kuai pub">发布求购</a>
                        </li>
                        <li class="col-xs-6 pa15 center mt20">
                             <a href="{{ route('member.publish.saler.add',['logo']) }}" class="kuai buy">发布卖品</a>
                        </li>
                    </ul> 
                        ...
                        <div class="tab-content">
                          <div role="tabpanel" class="tab-pane active" id="home">
                            <ul class="list mt15">
                                ...
                                <li>
                                    <div class="row">
                                        <a href="" class="col-xs-3"><img src="{{ asset('modules/member/images/avatar.jpg') }}" class="ml15" width="130" height="130"/></a>
