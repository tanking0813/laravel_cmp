            ...
            <div class="addState">
                ...
                <div class="jcs-l-box">
                    ...
                    <div class="jc-appro-items">
                        <h4><em></em>全部商标</h4>
                        <ul class="cly-detail">
                            <li class="active"><a href="{{ route('search.logo.monitor.approx.hand.order') }}">按各期近似度全部倒排</a></li>
                                ...
                                <table class="liebiao">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>国际分类</th>
                                            <th>商标名称</th>
                                            <th style="width: 400px;">申请人名称(中文)</th>
                                            <th>近似度</th>
                                            <th>操作</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <img src="{{ asset('modules/search/images/star.png') }}" />
                                                <img src="{{ asset('modules/search/images/star.png') }}" />
                                                <img src="{{ asset('modules/search/images/star-half.png') }}" />
                                                <img src="{{ asset('modules/search/images/star-half.png') }}" />
                                                <img src="{{ asset('modules/search/images/star-half.png') }}" />
                                            </td>
                                            <td><a href="{{ route('search.logo.monitor.approx.show', ['id'=>1]) }}">查看</a></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td>10675403</td>
                                            ...
                                            <td>北京科技园建设(集团)股份有限公司</td>
                                            <td></td>
                                            <td><a href="{{ route('search.logo.monitor.approx.show', ['id'=>2]) }}">查看</a></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td>10675403</td>
                                            ...
                                            <td>北京科技园建设(集团)股份有限公司</td>
                                            <td></td>
                                            <td><a href="{{ route('search.logo.monitor.approx.show', ['id'=>3]) }}">查看</a></td>
                                        </tr>
                                        <tr>
                                            <td>1</td>
                                            <td>10675403</td>
                                            ...
                                            <td>北京科技园建设(集团)股份有限公司</td>
                                            <td></td>
                                            <td><a href="{{ route('search.logo.monitor.approx.show', ['id'=>4]) }}">查看</a></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
