                ...
                <div class="bd">
                                ...
                                <form class="form-horizontal" role="form">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-xs-1 mate-box pa0">
                                            <div class="dropdown-toggle" data-toggle="dropdown">模糊匹配
                                ...
                                <table class="liebiao">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>北京华商动力知识产权代理有限公司</td>
                                            <td></td>
                                            <td><a href="javascript:;" class="free">免费</a><a href="javascript:;">删除</a></td>
                                        </tr>
                                        <tr>
                                            <td>北京华商动力知识产权代理有限公司</td>
                                            <td></td>
                    ...
                    <div class="lh jinsi-box">
                                ...
                                <table class="liebiao">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>北京华商动力知识产权代理有限公司</td>
                                            <td>11</td>
                                            <td><a href="">查看</a><a href="javascript:;">购物车</a></td>
                                        </tr>
                                        <tr>
                                            <td>北京华商动力知识产权代理有限公司</td>
                                            <td>11</td>
                        ...
                        <div class="jc-sp-wfirstTrial jcs-items">
                            <div class="jc-sp-wtitle">
                                <b>购物车</b>
                                <span class="hint-info">您当前是普通会员，附送名额：2个，目前您已成功手动添加1个。 您还有1个免费名额。<a href="jc-price.html">收费标准?</a></span>
                            </div>
                            <div class="state-a-table2 jcs-i-list mb0">
                                <table class="liebiao">
                                    <thead>
