		...
		<div class="d-matter">
			<div class="d-details">
				...
				<div class="result-list-box add-info-box">
					<div class="special-title">无线网址</div>
					<div class="common-website">
						...
						<div class="web-info-form">
							<div class="i-title">无线网址信息</div>
							<form class="form-horizontal" role="form">
								<div class="form-group">
									<label for="zc-commonWeb" class="col-xs-2 control-label">注册无线网址：<span>*</span></label>
								...
								<div class="form-group">
									...
									<p class="form-control-static web-price">无线网址 dfgfea:2800元/12年×1</p>
								</div>
								<div class="form-group">
						...
						<div class="c-w-mix">
							<div class="terms-service"><span></span>
								我已阅读，理解并接受【<a href="javascript:;" data-toggle="modal" data-target="#serviceTerms-Modal">无线网址在线注册服务条款</a>】
							</div>
							<div class="btn-group">
