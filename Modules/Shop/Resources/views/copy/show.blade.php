...
@section('banner')
	...
	<div class="row banner">
		<div class="col-xs-12">{{ HTML::image('modules/shop/images/test/cbanner2.png') }}</div>
	</div>
	<!--banner结束-->
@stop
	...
	<div class="container m-main">
		<div class="row mt20">
			<div class="col-xs-12 details">
				...
				<div class="row">
					<div class="col-xs-12">
						<p class="station"><a href="{{ route('shop')}}">柚皮网首页</a>&nbsp;＞&nbsp;<a href="{{ route('shop.copy.category',$shops['data']['category_id'])}}">{{ $shops['data']['category']['name'] }}</a>&nbsp;＞&nbsp;商品详情</p>
					</div>
				</div>
				<!--返回首页导航结束-->
				<!--商品详情开始-->
					...
					<div class="col-xs-9 goods">
						...
						<div>
							...
							<div class="tb-property fr">
									        ...
									        <div class="modal-body modal-yijia">
									        	...
									        	<div class="ware mt10">
										        	...
										        	<div class="tbp fr mt10">
														<p class="tbp-name">【著作名称】{{ $shops['data']['title'] }}</p>
														<p>作者:{{ $shops['data']['author'] }} </p><p>著作分类: {{ $shops['data']['category']['name'] }}</p> 
														<p>权利归属: {{ $shops['data']['right_attribution'] }} </p>
								...
								<!-- 加入购物车弹出框结束 -->
								<div class="tbp-name">【著作名称】{{ $shops['data']['title'] }}</div>
								<div class="tbp-price">￥{{ $shops['data']['price'] }}<del>￥84999</del></div>
								<div class="tbp-summary mt10">
									<span>作者:{{ $shops['data']['author'] }} </span>              
									<span>著作分类: {{ $shops['data']['category']['name'] }}</span><br> 
									<span>权利归属: {{ $shops['data']['right_attribution'] }} </span>              
									<span>权利来源: {{ $shops['data']['right_source'] }} </span><br>
									<span>权利种类: {{ $shops['data']['right_type'] }} </span>
								</div>
								<div class="tbp-summary mt10">
									<span>著作完成日期: {{ $shops['data']['copy_date'] }}</span><br>
								</div>
