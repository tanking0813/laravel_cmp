			...
			<div class="col-xs-10 ex-m-right">
				...
				<div class=" ex-mr1">
					<ul class="list-inline flo1">
						<li>
							<a href="">
								<p class="ding-img">{{ HTML::image('modules/shop/images/test/c-pic1.png') }}</p>
								<p>{{ HTML::image('modules/shop/images/icon/line-r.png') }}</p>
								<p class="lap1 cr">九寨沟诺日朗瀑布</p>
								<p>{{ HTML::image('modules/shop/images/icon/line-r.png') }}</p>
								<div class="dk">
									<p class="lap2 cr">热销理由</p>
									<p class="lap3">文字运用给人调皮轻松的感觉，容易被人所接受</p>
									<del>￥84999</del>
									<p class="lap4 cr">￥14999</p>
									<p class="lap5">立即购买</p>
								</div>
							</a>
						</li>
						<li>
							<a href="">
								<p class="ding-img">{{ HTML::image('modules/shop/images/test/c-pic2.png') }}</p>
								<p>{{ HTML::image('modules/shop/images/icon/line-r.png') }}</p>
								<p class="lap1 cr">《自然和谐风光》</p>
								<p>{{ HTML::image('modules/shop/images/icon/line-r.png') }}</p>
								<div class="dk">
									<p class="lap2 cr">热销理由</p>
									<p class="lap3">文字运用给人调皮轻松的感觉，容易被人所接受</p>
						...
						<li style="background:none;">
							<a href="">
								<p class="ding-img">{{ HTML::image('modules/shop/images/test/c-pic3.png') }}</p>
								<p>{{ HTML::image('modules/shop/images/icon/line-r.png') }}</p>
								<p class="lap1 cr">红红火火》摄影作品</p>
								<p>{{ HTML::image('modules/shop/images/icon/line-r.png') }}</p>
								<div class="dk">
									<p class="lap2 cr">热销理由</p>
									<p class="lap3">文字运用给人调皮轻松的感觉，容易被人所接受</p>
