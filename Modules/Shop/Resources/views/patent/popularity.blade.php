...
@section('banner')
	...
	<div class="row banner">
		<div class="col-xs-12">{{ HTML::image('modules/shop/images/test/pbanner2.png') }}</div>
	</div>
	<!--banner结束-->
@stop
...
<div class="container m-main">
	<div class="row ex-main mt20">
		...
		<div class="col-xs-2 ex-m-left">
			<!--左部-按分类手风琴开始-->
			<div class="ex-ml3">
				<div class="foreign-l-tit2">快捷导航</div>
				<ul class="list-unstyled m-tm-list3">
					<li id="mainCate-1" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list1.png') }}</span>农林渔牧 / 食品</a>
					</li>
					<li id="mainCate-2" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list2.png') }}</span>能源 / 动力 / 电力</a>
					</li>
					<li id="mainCate-2" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list3.png') }}</span>交通 / 运输 / 包装</a>
					</li>
					<li id="mainCate-3" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list4.png') }}</span>化工 / 冶金 / 生物</a>
					</li>
					<li id="mainCate-4" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list5.png') }}</span>纺织 / 造纸</a>
					</li>
					<li id="mainCate-5" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list6.png') }}</span>建筑 / 采挖 / 照明</a>
					</li>
					<li id="mainCate-6" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list7.png') }}</span>机械 / 加工 / 照明</a>
					</li>
					<li id="mainCate-7" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list8.png') }}</span>服饰 / 日用 / 家电</a>
					</li>
					<li id="mainCate-8" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list9.png') }}</span>通信 / 电子 / 数码</a>
					</li>
					<li id="mainCate-9" class="mainCate">
						<a href=""><span class="m-tm-icon-list">{{ HTML::image('modules/shop/images/icon/pat-list10.png') }}</span>医疗 / 保健 / 美容</a>
					</li>
				</ul>
			</div>
			<!--左部-按分类手风琴结束-->
			...
			<div class="ex-ml2 mt10">
				...
				<div class="bd">
					<ul class="list-unstyled ex-ml-list">
						<li>
							<a href="">
								<div class="ex-pic fl">{{ HTML::image('modules/shop/images/test/pat-pro16.png') }}</div>
						...
						<li>
							<a href="">
								<div class="ex-pic fl">{{ HTML::image('modules/shop/images/test/pat-pro17.png') }}</div>
								<div class="ex-text fr">第25类服装鞋帽商标<p>￥999<del>已售</del></p></div>
								<div class="clear"></div>
							</a>
						</li>
					...
					<ul class="list-inline list-unstyled">
						<li>
							<a href="" target="_blank">
								<p class="pb-pic">{{ HTML::image('modules/shop/images/test/pat-pro19.png') }}</p>
							</a>
						</li>
						<li>
							<a href="" target="_blank">
								<p class="pb-pic">{{ HTML::image('modules/shop/images/test/pat-pro20.png') }}</p>
							</a>
						</li>
						<li>
							<a href="" target="_blank">
								<p class="pb-pic">{{ HTML::image('modules/shop/images/test/pat-pro21.png') }}</p>
							</a>
						</li>
						<li>
							<a href="" target="_blank">
